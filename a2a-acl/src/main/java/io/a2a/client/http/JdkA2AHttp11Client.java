...
public class JdkA2AHttp11Client implements A2AHttpClient {

    private final HttpClient httpClient;

    public JdkA2AHttp11Client() {
    ...
    private class JdkDeleteBuilder extends JdkBuilder<DeleteBuilder> implements DeleteBuilder {
